    ...
    cameras = [
        {
            ...
            'port': int(os.environ.get('CAMERA1_PORT')),
            'user': os.environ.get('CAMERA1_USER'),
            'pass': os.environ.get('CAMERA1_PASS'),
            'rtsp_url': f"rtsp://{os.environ.get('CAMERA1_USER')}:{os.environ.get('CAMERA1_PASS')}@{os.environ.get('CAMERA1_IP')}:554/live/ch0"
        },
        {
            'ip': os.environ.get('CAMERA2_IP'),
            'port': int(os.environ.get('CAMERA2_PORT')),
            'user': os.environ.get('CAMERA2_USER'),
            'pass': os.environ.get('CAMERA2_PASS'),
            'rtsp_url': f"rtsp://{os.environ.get('CAMERA2_USER')}:{os.environ.get('CAMERA2_PASS')}@{os.environ.get('CAMERA2_IP')}:554/live/ch0"
        }
    ]
